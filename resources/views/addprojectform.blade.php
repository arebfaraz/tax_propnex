...
<body class="bg-primary">
    ...
    @endif
    <form action="/addprojects" method="POST" class="text-white py-5 px-8">
        @csrf
        <h1 class="text-4xl">Add New Project</h1>
            ...
            <div class="mt-2">
                <div class="flex items-end">
                    <div class="flex flex-col w-40">
                        ...
                        <input name="name" class="text-black text-sm" type="text" required>
                    </div>
                    <div class="flex flex-col w-40 mx-4">
                        <span class="px-1 text-sm">
                            Block Number</span>
                        <input name="block_number" class="text-black text-sm" type="text"
                ...
                <div class="flex items-end">
                    <div class="flex flex-col w-40">
                        ...
                        <input name="unit_number" class="text-black text-sm" type="text"
                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                            required>
                    </div>
