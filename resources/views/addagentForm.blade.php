...
<body class="bg-primary">
    ...
    @endif
    <form action="/addagents" method="POST" class="text-white py-5 px-8">
        @csrf
        <h1 class="text-4xl">Add New Agent</h1>
            ...
            <div class="mt-2">
                <div class="flex items-end">
                    <div class="flex flex-col w-40">
                        ...
                        <input name="account_name" class="text-black text-sm" type="text" required>
                    </div>
                    <div class="flex flex-col w-40 mx-4">
                        <span class="px-1 text-sm">
                            Company Name</span>
                        <input name="biz_name" class="text-black text-sm" type="text" required>
                    </div>
                ...
                <div class="flex items-end">
                    <div class="flex flex-col w-40">
                        ...
                        <input name="phone" class="text-black text-sm" type="text" required>
                    </div>
                    <div class="flex flex-col w-40 mx-4">
                        <span class="px-1 text-sm">
                            Email</span>
                        <input name="email" class="text-black text-sm" type="email" required>
                    </div>
                ...
                <div class="flex items-end">
                    <div class="flex flex-col w-40">
                        ...
                        <input name="passport_no" class="text-black text-sm" type="text" required>
                    </div>
