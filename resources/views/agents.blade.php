...
<body class=" bg-primary">
    ...
    <div class="text-white py-5 px-8">
        <h1 class="text-4xl">Agents Details</h1>
        <div class="bg-black/10 mt-8 py-6 px-3">
            ...
            <section id="" class=" px-4 w-4/4">
                ...
                <div class="flex justify-end">
                    ...
                    <a href="/agentsform"> <button style="float: right"
                    ...
                    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block w-full py-2 align-middle md:px-6 lg:px-8">
                            <div  class="overflow-hidden  dark:border-gray-700 ">
                                <table id="myTable" class=" w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody id="tabledata"
                                        ...
                                        @if (count($allAgents) > 0)
                                            ...
                                            @foreach ($allAgents as $allAgent)
                                                <tr>
                                                    <th class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                                                        scope="row">{{ $i++ }}</th>
                                                    <td
                                                        class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        {{ $allAgent->pxc_id }}</td>
                                                    <td
                                                        class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        {{ $allAgent->propnex_id }}</td>
                                                    <td
                                                        class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        {{ $allAgent->id_passport_no }}</td>
                                                    <td
                                                        class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        {{ $allAgent->account_name }}</td>
                                                    <td
                                                        class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        {{ $allAgent->biz_name }}</td>
                                                    <td
                                                        class="px-1 py-1 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        {{ $allAgent->phone }}</td>
                                                    <td
                                                    ...
                                                    <td class="px-1 py-1 text-sm font-normal text-left rtl:text-right ">
                                                        <a class="text-blue-600 dark:text-gray-400 mr-4"
                                                            href="editagents/{{ $allAgent->id }}">Edit</a>

                                                        <button class="text-red-600 dark:text-gray-400"> <a
                                                                href="deleteagent/{{ $allAgent->id }}">Delete</a></button>
                                                    </td>
                                                </tr>
